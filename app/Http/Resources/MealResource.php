...
class MealResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'image_url' => $this->image_path ? config('app.url') . Storage::url($this->image_path) : null,
            'gallery_images' => $this->gallery_images,
            'gallery_urls' => $this->gallery_images ? array_map(fn($path) => config('app.url') . Storage::url($path), $this->gallery_images) : [],
            'price' => $this->price,
